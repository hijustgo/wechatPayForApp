...
require_once ROOT.'/conf/wxpay.config.php';
...
class WxPayApi
{
	...
	{
		//获取通知的数据
		//$xml = $GLOBALS['HTTP_RAW_POST_DATA']; //这个方法需要配置php.ini，不然报错
	...
	{		
		...
		if(stripos($url,"https://")!==FALSE){
			curl_setopt($ch, CURLOPT_SSLVERSION, CURL_SSLVERSION_TLSv1);	//详见公告：https://mp.weixin.qq.com/cgi-bin/announce?action=getannouncement&key=1414562353&version=11&lang=zh_CN
